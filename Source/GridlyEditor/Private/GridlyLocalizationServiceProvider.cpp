	...
	TWeakObjectPtr<ULocalizationTarget> LocalizationTarget, bool bIsTargetSet)
{
	...
	const EAppReturnType::Type MessageReturn = FMessageDialog::Open(EAppMsgType::YesNo,
		LOCTEXT("ConfirmText",
			"This will overwrite your source strings on Gridly with the data in your UE5.3 project. Are you sure you wish to export?"));
	...
	bool bIsTargetSet)
{
	...
	const EAppReturnType::Type MessageReturn = FMessageDialog::Open(EAppMsgType::YesNo,
		LOCTEXT("ConfirmText",
			"This will overwrite all your source strings AND translations on Gridly with the data in your UE5.3 project. Are you sure you wish to export?"));
